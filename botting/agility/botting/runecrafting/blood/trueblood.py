...
while True:
    ...
    if center == bank:
        ...
        try:
            ...
            Randomize((wallrect[0]+9,wallrect[0]+9,wallrect[1]+12,wallrect[1]+12)).randleftspeed()
            passed = 1
            time.sleep(7)
        ...
        try:
            wallrect=findobj(wall)
            Randomize((wallrect[0]+9,wallrect[0]+9,wallrect[1]+8,wallrect[1]+8)).randleftspeed()
            time.sleep(7)
        except:
            print('oof')
